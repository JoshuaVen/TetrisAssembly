...
DATASEG SEGMENT PARA 'Data'
  MSG_AUTHOR DW "BY JOSHUA VEN AND NISHA ALEXIS, 2018 $"
  MSG_NEXT DW "NEXT $"
  MSG_LEFT DW "A - Left $"
  MSG_RIGHT DW "S - Right $"
  MSG_ROTATE DW "SPC - Rotate $"
  MSG_QUIT DW "Q - Quit $"
  MSG_LINES DW "Lines $"
  MSG_GAME_OVER DW "GAME OVER $"
...
PROCEDURE_IS_HORIZONTAL_LINE_FULL PROC FAR
  PUSH CX
  PUSH DI
...
PROCEDURE_IS_LINE_AVAILABLE PROC FAR
  PUSH BX
  PUSH CX
  PUSH DI
